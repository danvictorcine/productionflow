...
interface CreateEditStoryboardSceneDialogProps {
  ...
  onSubmit: (data: Omit<StoryboardScene, 'id' | 'storyboardId' | 'order'>) => void;
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetContent className="sm:max-w-lg">
        <SheetHeader>
          ...
          <SheetDescription>
            {isEditMode ? "Atualize os detalhes da sua cena." : "Dê um título e uma breve descrição para a cena."}
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="ex: INT. CAFETERIA - DIA" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Descreva brevemente o que acontece na cena." {...field} rows={4} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
