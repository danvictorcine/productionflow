// @/src/components/create-edit-unified-project-dialog.tsx
"use client";
...
interface CreateEditUnifiedProjectDialogProps {
  isOpen: boolean;
  setIsOpen: (isOpen: boolean) => void;
  onSubmit: (data: Omit<UnifiedProject, 'id' | 'userId' | 'createdAt'>) => void;
  project?: UnifiedProject;
}

export function CreateEditUnifiedProjectDialog({ isOpen, setIsOpen, onSubmit, project }: CreateEditUnifiedProjectDialogProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="ex: Curta-metragem 'Amanhecer'" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
